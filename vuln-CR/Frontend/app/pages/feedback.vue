...
// The function after edditting and making the input saniyized
async function getFeedbacks() {
  ...
  if (!response.ok) {
    ...
    // Sanitize the feedback content before displaying
    feedbacks.value = data.feedbacks.map((feedback) => ({
      ...feedback,
      feedback: DOMPurify.sanitize(feedback.feedback),
    }));
  }
}
